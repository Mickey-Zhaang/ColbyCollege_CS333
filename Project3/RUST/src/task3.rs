...
fn main() {
    ...
    let b: i32 = 3;
    let sum: i32 = a + b; // + -> i32
    let diff: i32 = a - b; // - -> i32
    let prod: i32 = a * b; // * -> i32
    let quot: i32 = a / b; // / -> i32 (integer division, truncates)
    let rem: i32 = a % b; // % -> i32 (remainder)
    println!(
        "i32 ops: sum={} diff={} prod={} quot={} rem={}",
    ...
    let y: f64 = 3.0;
    let fsum: f64 = x + y;
    let fquot: f64 = x / y; // actual division, not truncation
